...
test("Can close confirm end workday dialog by clicking the cancel button", async ({
	page,
}) => {
	await page.goto("/");
	// Fill in the initial form
...
test.skip("Can close confirm end workday dialog by clicking outside it", async () => {});
